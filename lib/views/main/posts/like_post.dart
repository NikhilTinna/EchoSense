  ...
  void getCurrentUserData() async {
    ...
    for (var element in quotePosts) {
      ...
      http.Response commentCountRes =
          await get("$url/comments/count/${element["post"]["id"]}");
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    quotePosts[index]["post"]["user"]["name"],
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                quotePosts[index]["post"]["imageurl"] != null
                                    ? Column(
                                        children: [
                                          const SizedBox(
                                            height: 10,
                                    ...
                                    : Container(),
                                quotePosts[index]["post"]["quotedPostId"] !=
                                        null
                                    ? Container(
